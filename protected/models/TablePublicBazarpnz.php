...
/**
 * This is the model class for table "table_public_bazarpnz".
 *
 * The followings are the available columns in table 'table_public_bazarpnz':
 * @property integer $id
 ...
 */
class TablePublicBazarpnz extends CActiveRecord
{
	/**
	 ...
	 * @return TablePublicBazarpnz the static model class
	 */

	...
	public function append_cronjob($cron_jobs=NULL)
{
	...
	public function remove_cronjob_by_key($cron_key=NULL)
	{	
		if (is_null($cron_key)) $this->error_message("Nothing to remove!  Please specify the key for the remove.");
		...
		if (empty($cron_array))
		{
			...
			$cron_key=intval($cron_key);
			if(isset($cron_array[$cron_key])) {
				unset($cron_array[$cron_key]);
			}else{
				echo 'Нет такого елемента';
			}
		}

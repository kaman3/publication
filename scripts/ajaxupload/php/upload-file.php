...
if($_GET['phpsid'])
{
    $uploaddir = $_SERVER['DOCUMENT_ROOT'].'/publish/images/cacheImg/'.trim($_GET['phpsid']).'/';
}else
{
	$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/publish/images/user'.trim($_GET['userId']).'/'.trim($_GET['idTmp']).'/'; 
}
